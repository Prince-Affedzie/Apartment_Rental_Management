      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-gray-600">
                View and manage all apartment properties
              </p>
            </div>
          ...
          <div className="flex justify-end mb-4">
            <button
              onClick={() =>
                exportToExcel(apartments, "Apartments_List", fields)
              }
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 mb-6">
                {currentItems.map((apt) => (
                  ...
                  <div
                    key={apt._id}
                    className="bg-white border border-gray-100 rounded-xl p-4 sm:p-5 hover:shadow-md transition-shadow h-full flex flex-col"
                  >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="font-medium">
                          GHC {selectedApartment.price}/month
                        </p>
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {selectedApartment.tenantCount}{" "}
                        {selectedApartment.tenantCount === 1
                          ? "Tenant"
                          : "Tenants"}
                      </p>
                    </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100 flex justify-end gap-3">
                    ...
                    <button
                      onClick={() => {
                        setSelectedApartment(null);
                        navigate(
                          `/apartments/${selectedApartment._id}/tenants`
                        );
                      }}
