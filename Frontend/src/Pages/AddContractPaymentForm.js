...
const AddContractPayment = () => {
  const { createPayment } = useContractPayments();
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="px-6 py-4 bg-white border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Add Contract Payment</h1>
              <p className="text-gray-600 text-sm mt-1">Record a new payment for a contract</p>
            </div>
            <button
              onClick={() => navigate("/contract_payment/list")}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-green-600 to-green-800 px-6 py-4">
                ...
                <p className="text-green-100 text-sm mt-1">Enter the payment information</p>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      ...
                      {contracts.map((contract) => (
                        <option key={contract._id} value={contract._id}>
                          ...
                          {contract.vehicleId?.vehicleRegNum ? ` ${contract.vehicleId.vehicleRegNum}` : ''}
                        </option>
                      ))}
                    </select>
                    {errors.contractId && (
                  ...
                  <div className="flex gap-3 justify-end pt-6 border-t border-gray-200">
                    ...
                    <button
                      type="submit"
                      disabled={submitting}
                      className="px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 disabled:opacity-60 transition-all duration-200 flex items-center"
                    >
                      {submitting ? (
                        <>
