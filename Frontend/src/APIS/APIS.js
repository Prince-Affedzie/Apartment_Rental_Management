...
export const addTenantRecord = (data) =>
  API.post("/api/create_rent/record", data);
...
export const editTenant = (Id, data) =>
  API.put(`/api/edit/rent_record/${Id}`, data);
export const deleteTenantRecord = (Id) =>
  API.delete(`/api/delete/rent_record/${Id}`);
export const addApartmentProperty = (data) =>
  API.post("/api/add/apartment_property", data);
export const getApartmentProperties = () =>
  API.get("/api/get/apartment_properties");
export const updateApartment = (Id, data) =>
  API.put(`/api/edit/apartment_property/${Id}`, data);
export const getSingleApartment = (Id) =>
  API.get(`/api/get/apartment_property/${Id}`);
export const deleteApartment = (Id) =>
  API.delete(`/api/delete/apartment_property/${Id}`);
...
export const addPayment = (data) =>
  API.post("/api/apartment/add_payment", data);
export const editPayment = (Id, data) =>
  API.put(`/api/apartment/edit_payment/${Id}`, data);
export const deletePayment = (Id) =>
  API.delete(`/api/apartment/delete_payment/${Id}`);
...
export const getTenantsByApartment = (apartmentId) =>
  API.get(`/api/get/${apartmentId}/apartment_property_tenants`);

// Vehicles
export const getVehicles = () => API.get("/api/get/vehicle_records");
export const addVehicleRecord = (data) =>
  API.post("/api/add/vehicle_record", data);
export const getSingleVehicle = (Id) =>
  API.get(`/api/get/vehicle_record/${Id}`);
export const updateVehicle = (Id, data) =>
  API.put(`/api/edit/vehicle_record/${Id}`, data);
export const deleteVehicleRecord = (Id) =>
  API.delete(`/api/delete/vehicle_record/${Id}`);
export const addMaintenanceRecord = (data) =>
  API.post("/api/add/maintenance_record", data);
export const getMaintenanceRecords = () =>
  API.get("/api/get/maintenance_records");
export const getSingleMaintenanceRecord = (Id) =>
  API.get(`/api/get/vehicle_maintenance_record/${Id}`);
export const deleteMaintenanceRecord = (Id) =>
  API.delete(`/api/delete/maintenance_record/${Id}`);
export const updateMaintenanceRecord = (Id, data) =>
  API.put(`/api/edit/vehicle_maintenance/${Id}`, data);
...
export const updateContract = (Id, data) =>
  API.put(`/api/update_contract/${Id}`, data);
export const deleteContract = (Id) => API.delete(`/api/delete_contract/${Id}`);

//  Contract Payment APIs
export const getAllContractPayments = () =>
  API.get(`/api/get_all_contract_payments`);
export const getSingleContractPayment = (Id) =>
  API.get(`/api/get_contract_payment/${Id}`);
export const addContractPayment = (data) =>
  API.post(`/api/create_contract_payment`, data);
export const updateContractPayment = (Id, data) =>
  API.put(`/api/update_contract_payment/${Id}`, data);
export const deleteContractPayment = (Id) =>
  API.delete(`/api/delete_contract_payment/${Id}`);
...
export const updateDriver = (Id, data) =>
  API.put(`/api/update_driver/${Id}`, data);
